...
#+MACRO: pending @@html:<font color="red">&Cross;</font>@@ @@odt:<text:span text:style-name="HighlightRed">✘</text:span>@@
#+MACRO: cancel @@html:<font color="red">&Cross;</font>@@
#+MACRO: euro @@html:&euro;@@

#+MACRO: to_clarify @@html:<font color="red">&#x2753;&#x2757;</font>@@ @@odt:<text:span text:style-name="HighlightRed">‽</text:span>@@
#+MACRO: alert @@html:<font color="red"><b>$1</b></font>@@
